...
from decorators import is_registered, listToString
...
class EconomyCog(commands.Cog):
    ...
    async def balance(self, ctx, member: discord.Member = None):
        ...
        if language == "en":
            ...
            embed.add_field(name="Statystyki Ekonomii",
                            value=f"Portfel: **{wallet_amt}{actuallcurrency}**\nBank: **{bank_amt}{actuallcurrency}**\nRazem: **{wallet_amt + bank_amt}{actuallcurrency}**",
                            inline=False)
